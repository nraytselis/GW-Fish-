...
Pond_ODE =function(t, y, parameters) {
  ...
  with(as.list(parameters),{
    ...
    dPredsdt = convEff*(Pred_N*N + Pred_J*J + Pred_A*A + Pred_A*sum(Es)) - d_F*Preds 
...
Initial_conditions = c(N = round(7992.454), J = round(8527.531), A = round(1763.213), Exposed_values, I = 0, Preds = 15,L3F = 0)/15
timespan = 365*5
